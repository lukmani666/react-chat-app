...
const Register = () => {
  ...
  return (
    <div className='bg-[#a7bcff] h-screen flex items-center justify-center'>
      <div className="regiter_container flex flex-col p-2 justify-center w-full h-full md:w-8/12 md:p-10 md:h-fit md:rounded-2xl lg:rounded-2xl lg:w-4/12 lg:p-10 lg:h-fit" >
